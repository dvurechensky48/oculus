...
<div id="footer">
        <section id="footer-1" class="blue medium">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div>
                            <a href="/litsenziya.php" class="button3">Лицензии и сертификаты</a>
                            <a href="/nadzornye-organy.php" class="button3">Надзорные органы</a>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="text margin-top-2">
                        ...
                        <div class="col-xs-4 all-right">
                            made in <a class="octavian" title="Разработка и поддержка сайтов" target="_blank" href="https://octavian48.ru/">OCTAVIAN</a>
                        </div>
                    </div>
                </div>
            </div>
 ...
 <input class="zapis" type="text" name="" placeholder="Ваше имя">
            ...
            <div id = "toTop" class="animated hidden-xs hidden-sm"> ^ Наверх </div>
        </section>
...
var posMenu = document.querySelector('#main-menu').getBoundingClientRect().top;
if(posMenu < 0)
{
    document.querySelector('#main-menu-fix').style.display = 'block';
}
else
{
   document.querySelector('#main-menu-fix').style.display = 'none';
}

if($(this).scrollTop() != 0) 
{

    document.getElementById('toTop').classList.remove('fadeOutRight');
    document.getElementById('toTop').classList.add('fadeInRight');
 
} 
else 
{
 
    document.getElementById('toTop').classList.remove('fadeInRight');
    document.getElementById('toTop').classList.add('fadeOutRight');
}
